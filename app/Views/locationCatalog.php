        ...
        <article class="location-item-card">
            <div class="location-item-card__inner">
                ...
                <div class="location-item-card__front">
                    <?php if (!empty($item->getPictures())): ?>
                    <div class="location-item-card__main">
                        <img src="<?= htmlspecialchars($item->getMainImage()) ?>"
                            alt="<?= htmlspecialchars($item->name) ?>" class="location-card__image">
                ...
                <div class="location-item-card__back">
                    ...
                    <ul>
                        ...
                        <li>
                            <strong><?= htmlspecialchars($attrName) ?>:</strong>
